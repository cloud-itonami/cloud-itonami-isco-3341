...
`cloud-itonami-isco-3341` is an OSS open-occupation blueprint. Governance
...
- the Advisor cannot directly dispatch robot actions, commit operating
  records, or finalize a disciplinary action, termination or
  performance-review determination.
- Office Supervision Governor remains independent of the advisor.
- hard policy violations cannot be overridden by human approval.
- every commit, hold and approval path is auditable.
- real staff/operator data stays outside Git.
...
- mishandling staff/operator data
- misrepresenting certification status
- failing to respond to security incidents
- hiding material changes to customer-facing operation
- allowing any path that finalizes a disciplinary action, termination or
